        ...
        <div class="flex flex-col lg:flex-row my-5">
            <div class="property-images px-4">
                <div class="carousel w-full" id="images">
                    <div :id="`image`+image.id" class="carousel-item w-full" v-for="image in property.images"
                         :key="image">
                        <img :src="image.url" class="w-full"/>
                    </div>
                </div>
                <div class="flex justify-center w-full py-2 gap-2">
                    <a :href="`#image`+index" class="btn btn-xs" v-for="index in images_count" :key="index"> {{
                        index
                        }} </a>
                </div>
                <!-- comments section -->
