<template>
  <div title="Change Theme" class="dropdown dropdown-end" id="theme-dropdown">
    ...
    <div
      ...
      <div class="grid grid-cols-1 gap-3 p-3" tabindex="0">
        <div
            class="outline-base-content theme-item overflow-hidden rounded-lg outline outline-2 outline-offset-2"
        ...
        <div class="outline-base-content theme-item overflow-hidden rounded-lg outline outline-2 outline-offset-2"
